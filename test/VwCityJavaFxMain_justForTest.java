 ...
 * @author XC8184
 */
public class VwCityJavaFxMain_justForTest extends Application {
    ...
    public VwCityJavaFxMain_justForTest(String times, String colorHash, MdCity mdCityObj, MdTimer mdtimerobj, int initialSpeed) {
    ...
    public VwCityJavaFxMain_justForTest() {
        this.colorHash = "blue";
